...
#        self.Food11.clicked.connect(self.Food11Clicked)
        ...
        self.Food12.setMinimumSize(130,130)
        self.Food12.move(100,500)
        self.Food12.setObjectName("Food12")
        self.Food12.hide()
#        self.Food12.clicked.connect(self.Food12Clicked)
