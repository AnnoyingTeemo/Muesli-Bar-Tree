...
class TestUI(QtWidgets.QWidget):
    ...
    def setup(self):
        ...
        self.Food0.hide()
        self.Food0.clicked.connect(self.Food1Clicked)
        ...
        self.Food2.hide()
        self.Food2.clicked.connect(self.Food1Clicked)
        ...
        self.Food3.hide()
        self.Food3.clicked.connect(self.Food1Clicked)
        ...
        self.Food4.hide()
        self.Food4.clicked.connect(self.Food1Clicked)
        ...
        self.Food5.hide()
        self.Food5.clicked.connect(self.Food1Clicked)
        ...
        self.Food6.hide()
        self.Food6.clicked.connect(self.Food1Clicked)
        ...
        self.Food7.hide()
        self.Food7.clicked.connect(self.Food1Clicked)
